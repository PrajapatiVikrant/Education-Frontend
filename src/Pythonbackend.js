    ...
    const options = {
     ...
     handler:async function(response){
      ...
      if(res.data === 'sign valid')
       ...
       alert('Congratulation,You have purchased python web development successfully');
     }
    };
  ...
  return (
    <>
      ...
      <div className="coursecard Mern" >
        ...
        <h1 className="hcoursename">Python web development</h1>
        <p className="haboutcourse">In this course you will learn python django flask Javascript HTML5 CSS3</p>
